...
export default function AccountPage() {
  ...
  const logoutAndLeave = () => { void fetch("/api/auth/google/logout/", { method: "POST", credentials: "include" }).finally(() => { logout(); router.push("/"); }); };
