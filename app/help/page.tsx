...
const helpCategories = [
  ...
  },
  {
    ...
    description: "الفواتير، سجل العمليات، المبالغ المستردة",
    articles: 18,
  },
  {
    icon: Shield,
...
const faqs = [
  ...
  {
    question: "كيف أراجع تفاصيل فاتورتي؟",
    answer:
      "يمكنك مراجعة تفاصيل الفاتورة من قسم العمليات داخل حسابك، وستظهر لك قيمة الطلب وتفاصيل المنتجات والحالة الحالية.",
  },
  {
